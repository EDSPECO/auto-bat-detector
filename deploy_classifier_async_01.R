...
unlink("/home/edspeco/ultrasonic_classifier/helpers/classification_finished.txt")
...
# write.table("Loading models into memory ...", file = "/home/edspeco/ultrasonic_classifier/helpers/status_update.txt")
fileConn<-file("/home/edspeco/ultrasonic_classifier/helpers/status_update.txt")
...
while (file.exists("/home/edspeco/ultrasonic_classifier/helpers/start.txt"))
{
	# print("From the R file: start.txt exists !")
	cat(magenta$bold('... '))                                                                                       # Heart beat.
	# cat(magenta$bold('From the R file: start.txt exists !\n'))
	if (file.exists("/home/edspeco/ultrasonic_classifier/helpers/classification_finished.txt"))
	{
	...
	if ((file.exists("/home/edspeco/ultrasonic_classifier/helpers/filtered_wav_ready.txt")) && (!file.exists("/home/edspeco/ultrasonic_classifier/helpers/classification_finished.txt")))
	{
		...
		# delete some files:
		unlink("/home/edspeco/ultrasonic_classifier/helpers/filtered_wav_ready.txt")
		...
		if (num_audio_events >1)
		{
			...
			if(confidence > 10)
			{
				...
				if(file.exists("/home/edspeco/ultrasonic_classifier/helpers/barchart_time.txt"))
				{
					value <- read.table("/home/edspeco/ultrasonic_classifier/helpers/barchart_time.txt")
				...
				{
					value <- read.table("/home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt")
					text_or_graph_or_spectogram <- value[c(1),c(1)]
					value2 <- read.table("/home/edspeco/ultrasonic_classifier/helpers/specto_resolution.txt")
					...
					if (text_or_graph_or_spectogram == "spectogram")
					{
						...
						system('python3 /home/edspeco/ultrasonic_classifier/create_barchart.py')
					}
				}
			}                                       # if confidence > 10
		...
		write.table("", file = "/home/edspeco/ultrasonic_classifier/helpers/classification_finished.txt")
		fileConn<-file("/home/edspeco/ultrasonic_classifier/helpers/status_update.txt")                     # GUI displays live status update.
		writeLines(c("No audio events detected !!"), fileConn)
		close(fileConn)
		Sys.sleep(0.5)
		}
	} else {                                        # if (file.exists("/home/edspeco/ultrasonic_classifier/unknown_bat_audio/filtered.wav"))
