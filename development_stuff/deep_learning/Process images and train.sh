...
cd /media/edspeco/Xavier_SD/dog-breed-identification/

python3 data_processing.py

# Copy inception into /tmp/imagenet/inception-2015-12-05.tgz (85 Mb) or else it will be downloaded:
cp /media/edspeco/Xavier_SD/dog-breed-identification/imagenet /tmp
...
cd /media/edspeco/Xavier_SD/dog-breed-identification/build/
