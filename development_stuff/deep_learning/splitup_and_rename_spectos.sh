...
# cd /home/edspeco/ultrasonic_classifier/development_stuff/deep_learning/ && bash splitup_and_rename_spectos.sh
# Images to process should be in /home/edspeco/ultrasonic_classifier/images/test/
...
# cd /media/edspeco/Xavier_SD/dog-breed-identification/build/plecotus_test_spectographs/test/
cd /home/edspeco/ultrasonic_classifier/images/test/
# cd /home/edspeco/ultrasonic_classifier/images/rhino_hippo_spectographs/
