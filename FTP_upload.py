...
# cd /home/edspeco/ultrasonic_classifier/ && echo whales | sudo -S python3 FTP_upload.py
...
file3 = '/home/edspeco/ultrasonic_classifier/helpers/CPU_temp.txt'
...
myPath = '/home/edspeco/ultrasonic_classifier/images/graphical_results/graph.png'
session = ftplib.FTP('##################','##################','##################')
...
# myPath = '/home/edspeco/ultrasonic_classifier/development_stuff/bat_detector.html'
# myPath = '/home/edspeco/ultrasonic_classifier/development_stuff/weather_station_files/showdata.php'


myPath = '/home/edspeco/ultrasonic_classifier/From_R_01.csv'
session = ftplib.FTP('##################','##################','##################')
file = open(myPath,'rb')                                    # file to send
...
myPath = '/home/edspeco/ultrasonic_classifier/IOT_stuff/html/saved_audio_files.html'
session = ftplib.FTP('##################','##################','##################')
file = open(myPath,'rb')                                    # file to send
...
# myPath = '/home/edspeco/ultrasonic_classifier/results/'
session = ftplib.FTP('##################','##################','##################')
...
for root, dirs, files in os.walk('/home/edspeco/ultrasonic_classifier/results/'):
    for fname in files:
...
files = glob.glob('/home/edspeco/ultrasonic_classifier/results/*')
for f in files:
    os.remove(f)


# Build subprocess command for running modem.sh:
path2script = '/home/edspeco/ultrasonic_classifier/modem.sh'
