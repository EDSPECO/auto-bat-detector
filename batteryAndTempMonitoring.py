...
# cd /home/edspeco/ultrasonic_classifier/ && python3 batteryAndTempMonitoring.py
"""
================================================
...
def main():
	...
	file = "/home/edspeco/ultrasonic_classifier/helpers/kernel.txt"
	...
	file6 = '/home/edspeco/ultrasonic_classifier/helpers/battery_info.txt'
	f= open(file6, "w+")
	f.write(message)
	f.close()
	
	if (batteryPackRead > 2) and (batteryPackRead < 10.5):                                 # Create alert file if battery pack is running low.
		file7 = '/home/edspeco/ultrasonic_classifier/helpers/batteryAlert.txt'
		f= open(file7, "w+")
		f.write(message)
		f= open(stopFile, "w+")
