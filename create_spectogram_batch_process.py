...
# cd /home/edspeco/ultrasonic_classifier/ && python3 create_spectogram_batch_process.py
# cd /home/edspeco/ultrasonic_classifier/ && chmod 775 create_spectogram_batch_process.py
...
file3 = '/home/edspeco/ultrasonic_classifier/helpers/count.txt'
file4 = '/home/edspeco/ultrasonic_classifier/helpers/bat_name.txt'

# file_to_process = "/home/edspeco/ultrasonic_classifier/unknown_bat_audio/filtered.wav"
...
directory = os.fsencode("/home/edspeco/ultrasonic_classifier/unknown_bat_audio/")
...
if os.path.isfile(file_to_process):
	...
	plot.savefig('/home/edspeco/ultrasonic_classifier/images/spectograms/'+ bat_name + str(count) + '.png', bbox_inches='tight', dpi=dpi)          # This will save spectograms with descrete filenames.
	print("three")
	count2 = int(count)+1
	print("count2 = ",count2)
	...
	f.write(str(count2))
	f.close()
	# plot.savefig('/home/edspeco/ultrasonic_classifier/images/spectograms/specto.png', bbox_inches='tight')                          # This will save just the current spectogram.
	# plot.show()
