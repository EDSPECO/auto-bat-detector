...
# cd /home/edspeco/ultrasonic_classifier/ && python3 create_spectogram.py
# cd /home/edspeco/ultrasonic_classifier/ && chmod 775 create_spectogram.py
...
if os.path.isfile(file_to_process):
	...
	plot.savefig('/home/edspeco/ultrasonic_classifier/images/spectograms/specto.png', bbox_inches='tight')
	# plot.show()
