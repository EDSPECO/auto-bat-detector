# cd /home/edspeco/ultrasonic_classifier/ && python GUI.py
# python GUI.py
import os
import time as t
import random as rd
...
class ButtonWindow(Gtk.Window):
    spectoFile= "/home/edspeco/ultrasonic_classifier/images/spectograms/specto.png"
    graphFile = '/home/edspeco/ultrasonic_classifier/images/graphical_results/graph.png'
...
###########################################################################
        ...
        file = "/home/edspeco/ultrasonic_classifier/helpers/toggled_01.txt"
        with open(file) as fp:
            textToggled = fp.read()
        fp.close()
        print(textToggled)
        file = "/home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt"
        with open(file) as fp:
...
###########################################################################      # Set defaults
        name = "UK_Bats" + "\n" + "Level1:_Species" + "\n" + "All_Calls"
        file = "/home/edspeco/ultrasonic_classifier/helpers/combo_01.txt"
...
############################################################################################
        ...
        #self.add(self.box2)
        toolbar = Gtk.Toolbar()
        selected_folder = "/home/edspeco/ultrasonic_classifier/my_audio"
        #         name_combo3.set_active(0)
...
##########################################################################       
        ...
        image = Gtk.Image()
        pixbuf = GdkPixbuf.Pixbuf.new_from_file("/home/edspeco/ultrasonic_classifier/images/goatlogo70high.jpg")
        ...
        # self.pixbuf2 = GdkPixbuf.Pixbuf.new_from_file("/home/edspeco/ultrasonic_classifier/images/spectograms/specto.png")
        ...
        if (textToggled2 == "settings"):
            ...
            file = '/home/edspeco/ultrasonic_classifier/helpers/threshold.txt'
            ...
            file = '/home/edspeco/ultrasonic_classifier/helpers/barchart_time.txt'
            if os.path.isfile(file):
                with open(file, "r") as fp:
                    value = fp.read()
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/chunk_size_record.txt"
            if os.path.isfile(file):
                with open(file, "r") as fp:
                    value = fp.read()
                fp.close()
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/chunk_size_process.txt"
            if os.path.isfile(file):
                with open(file, "r") as fp:
                    value = fp.read()
                fp.close()
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/specto_resolution.txt"
            if os.path.isfile(file):
                with open(file, "r") as fp:
                    value = fp.read()
                fp.close()    
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/fullscreen.txt"
            if os.path.isfile(file):
                with open(file, "r") as fp:
                    value = fp.read()
                fp.close()    
...
#######################################################################################################################
            ...
            selected_file = '/home/edspeco/ultrasonic_classifier/helpers/bat_name.txt'
...
#######################################################################################################################
        ...
        pixbuf_start = GdkPixbuf.Pixbuf.new_from_file_at_size("/home/edspeco/ultrasonic_classifier/images/start_250.png", 90, 90)
        ...
        pixbuf_stop = GdkPixbuf.Pixbuf.new_from_file_at_size("/home/edspeco/ultrasonic_classifier/images/stop_250.png", 90, 90)
...
#####################################################################################################
        ...
        file = '/home/edspeco/ultrasonic_classifier/instructions.txt'
        if os.path.isfile(file):
            with open(file) as fp:
                text2 = fp.read()
            fp.close()
...
#######################################################################################################################
    ...
    def on_bat_name_save_clicked(self, widget):
        save_file = '/home/edspeco/ultrasonic_classifier/helpers/bat_name.txt'
    ...
    def on_timeout(self, user_data):
        ...
        file = '/home/edspeco/ultrasonic_classifier/helpers/battery_info.txt'
        if os.path.isfile(file):
            with open(file, "r") as fp:
                battery = fp.read()
            fp.close()
        ...
        file = '/home/edspeco/ultrasonic_classifier/helpers/status_update.txt'
        if os.path.isfile(file):
            with open(file, "r") as fp:
                status = fp.read()
            fp.close()
...
########################################################################################################################
    def restart_clicked(self, button):
        ...
        file = "/home/edspeco/ultrasonic_classifier/alert_sounds/Go_for_Deploy.wav"
        os.system("aplay " + file)
        restartFile = "/home/edspeco/ultrasonic_classifier/helpers/restart.txt"
    ...
    def on_close_clicked(self, button):
        ...
        close_app = "/home/edspeco/ultrasonic_classifier/helpers/close_app.txt"
        f= open(close_app, "w+")
    ...
    def on_name_combo1_changed(self, combo):
        ...
        if tree_iter is not None:
            ...
            self.replace_line('/home/edspeco/ultrasonic_classifier/helpers/combo_01.txt', 0, name + '\n')
        else:
    ...
    def on_name_combo2_changed(self, combo):
        ...
        if tree_iter is not None:
            ...
            row_id, name = model[tree_iter][:2]
            print("Selected: ID=%d, name=%s" % (row_id, name))
            self.replace_line('/home/edspeco/ultrasonic_classifier/helpers/combo_01.txt', 1, name + '\n')
        else:
            entry = combo.get_child()
            print("Entered: %s" % entry.get_text())
    ...
    def on_name_combo3_changed(self, combo):
        ...
        if tree_iter is not None:
            ...
            row_id, name = model[tree_iter][:2]
            print("Selected: ID=%d, name=%s" % (row_id, name))
            self.replace_line('/home/edspeco/ultrasonic_classifier/helpers/combo_01.txt', 2, name + '\n')
        else:
            entry = combo.get_child()
            print("Entered: %s" % entry.get_text())
    ...
    def select_folder_clicked(self, widget):
        ...
        if response == Gtk.ResponseType.OK:
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/audio_files_path.txt"
    ...
    def record_and_classify(self, button, event):
        ...
        file = "/home/edspeco/ultrasonic_classifier/bash_app"
        os.system("bash " + file)

    def stop(self, widget, event):            # Stop image.
        print("stop")
        stopFile = "/home/edspeco/ultrasonic_classifier/helpers/stop.txt"
        startFile = "/home/edspeco/ultrasonic_classifier/helpers/start.txt"
        f= open(stopFile, "w+")
        if os.path.isfile(startFile):
            os.remove(startFile)
            print("start file removed")
    ...
    def shut_down_clicked(self, button):         # Shut down Pi.
        print("shut down")
        shutDownFile = "/home/edspeco/ultrasonic_classifier/helpers/shutDown.txt"
        startFile = "/home/edspeco/ultrasonic_classifier/helpers/start.txt"
...
#####################################################################################################
        ...
        while a==0:
            if os.path.isfile(stopFile):
                ...
                file = '/home/edspeco/ultrasonic_classifier/Final_result_copy.txt'
                if os.path.isfile(file):
                    current_time = time.ctime(os.path.getctime("/home/edspeco/ultrasonic_classifier/Final_result_copy.txt"))
                    newText = ""
                    line2 = ""
                    line3 = ""
                    zzz = ""
            ...
            elif (textToggled == "record") and (textToggled2 == "spectogram"):    # /home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt is where "text" or "spectogram" is stored according to button pressed.
                text = "This needs to be spectogram ......"
                num=rd.randint(1,60)
                # print(num)
                # print("\nFrom GUI.py: ... Trying to update spectogram: ....... ",num)
                waittime=6
                file = '/home/edspeco/ultrasonic_classifier/images/spectograms/specto.png'
                if (os.path.getsize(file) > 0):
            ...
            elif (textToggled == "record") and (textToggled2 == "graph"):    # /home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt is where "text" or "spectogram" is stored according to button pressed.
                num=rd.randint(1,60)
                # print(num)
                # print("\nFrom GUI.py: ... Trying to update barchart: ....... ",num)
                waittime=6
                file = '/home/edspeco/ultrasonic_classifier/images/graphical_results/graph.png'
                if (os.path.getsize(file) > 0):
            ...
            elif (textToggled == "process") and (textToggled2 == "spectogram"):    # /home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt is where "text" or "spectogram" is stored according to button pressed.
                text = "This needs to be spectogram ......"
                num=rd.randint(1,60)
                # print(num)
                # print("\nFrom GUI.py: ... Trying to update spectogram: ....... ",num)
            ...
            elif (textToggled == "process") and (textToggled2 == "graph"):    # /home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt is where "text" or "spectogram" is stored according to button pressed.
                num=rd.randint(1,60)
                # print(num)
...
#################################################################################################################################
    ...
    def text_reporting_clicked(self, button):
        name = "text"
        file = "/home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt"      # TODO: change file name to something better descriptive.
        f= open(file, "w+")                                                     # Create the file toggled_01.txt
        f.write(name)
        f.close()
        call('./restart_the_app.sh', shell=True)                                # Restart the app for toggle2 to take effect.
