# cd /home/edspeco/ultrasonic_classifier/ && python3 process_audio_files.py
# python3 process_audio_files.py
# cd /home/edspeco/ultrasonic_classifier/ && chmod 775 process_audio_files.py
...
# file = "/home/edspeco/ultrasonic_classifier/my_audio/noctula_Oct_31_2019_01.wav"
file = "/home/edspeco/ultrasonic_classifier/my_audio/11_oct_2019_01.wav"                # 110 Mb
file2 = "/home/edspeco/ultrasonic_classifier/Final_result.txt"
file3 = "/home/edspeco/ultrasonic_classifier/Final_result_copy.txt"
file4='/home/edspeco/ultrasonic_classifier/helpers/combo_01.txt'
file5 = "/home/edspeco/ultrasonic_classifier/helpers/toggled_02.txt"                    # text or spectigram or graph.
file6 = '/home/edspeco/ultrasonic_classifier/helpers/chunk_size_process.txt'            # chunk size process.
folder1 = "/home/edspeco/ultrasonic_classifier/"
folder2 = "/home/edspeco/ultrasonic_classifier/processed_audio/"
folder3 = "/home/edspeco/ultrasonic_classifier/unknown_bat_audio/"
folder4 = "/home/edspeco/ultrasonic_classifier/my_audio"
folder5 = "/home/edspeco/ultrasonic_classifier/temp/"
folder6 = "/home/edspeco/ultrasonic_classifier/helpers/"
directory = os.fsencode("/home/edspeco/ultrasonic_classifier/my_audio")
...
path_to_create_graph = "/home/edspeco/ultrasonic_classifier/create_barchart.py"
path_to_battery = "/home/edspeco/ultrasonic_classifier/battery_info.sh"                      # Not used anymore.
...
if ((line[1] == "UK_Bats\n") and (line[2] == "Level1:_Species\n")):
	path2script = '/home/edspeco/ultrasonic_classifier/deploy_classifier_async_01.R'
	print ("Level 1 was deployed")
elif ((line[1] == "UK_Bats\n" ) and (line[2] == "Level2:_Genera\n" )):
	# TODO: deploy_classifier_async_
	path2script = '/home/edspeco/ultrasonic_classifier/Deploy_bats_pi_Level2.R'
	print ("Level 2 was deployed")
elif ((line[1] == "UK_Bats\n" ) and (line[2] == "Level3:_Order\n" )):
	# TODO: deploy_classifier_async_
	path2script = '/home/edspeco/ultrasonic_classifier/Deploy_bats_pi_Level3.R'
...
for file in os.listdir(directory):                                       # This loop will carry on going as long as there are more files to process.
    ...
    if filename.endswith(".wav"):
        ...
        for i, chunk in enumerate(chunks):
            ...
            file = "/home/edspeco/ultrasonic_classifier/helpers/filtered_wav_ready.txt"
            f= open(file, "w+")
            f.write("nothing")
            f.close()
...
##############################################################################################################
                ...
                # path2script_3 = '/home/edspeco/ultrasonic_classifier/script_3.sh'
